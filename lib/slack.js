...
function getStatusObject(z, bundle) {
  ...
  console.log("--- Running 'getStatusObject'");
...
function createStatusObject(inData, userProfile) {
  ...
  if (inData.quittingTime !== undefined &&
    ...
    if (inData.eventEndTime.getHours() >= inData.quittingTime) {
  ...
  if (inData.eventBeginTime !== undefined &&
    ...
    if (inData.eventBeginTime.getHours() <= inData.startingTime) {
...
module.exports = {
  ...
  _defaultWeekendStatus: defaultWeekendStatus,
  _defaultNotAtWorkEmoji: defaultNotAtWorkEmoji
};